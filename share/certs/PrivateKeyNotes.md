...
unlocked to sign the POPCoin-Qt.app bundle.
...
allowing somebody to distribute a POPCoin-Qt.app or popcoin-qt-setup.exe with a valid
...
that the popcoin-qt.exe file inside the installer had not been tampered with.
